...
// 分页获取消息数据
export const getEssayData = (params) => {
    return getRequest('/essay/list', params)
}

export const saveEssay = (params) => {
    return postRequest('/essay/save', params)
}

// fleet
export const getFleetData = (params) => {
    return getRequest('/fleet/list', params)
}

// version
export const getVersionData = (params) => {
    return getRequest('/version/list', params)
}

export const saveVersion = (params) => {
    return postRequest('/version/save', params)
}

export const enableVersion=  (id, params)=> {
    return postRequest(`/version/enable/${id}`, params)
}

export const disableVersion=  (id, params)=> {
    return postRequest(`/version/disable/${id}`, params)
}

export const editVersion = (params) => {
    return postRequest('/version/update', params)
}

export const deleteVersion =  (id, params)=> {
    return postRequest(`/version/delByIds/${id}`, params)
}

// account
export const getAccountData = (params) => {
    return getRequest('/account/list', params)
}
